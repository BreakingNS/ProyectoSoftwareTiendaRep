...
CREATE CACHED TABLE "TIENDALOCAL"."MARCA"(
    "ID_MARCA" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 21) NOT NULL,
...
CREATE CACHED TABLE "TIENDALOCAL"."MODELO"(
    "ID_MODELO" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 21) NOT NULL,
...
CREATE CACHED TABLE "TIENDALOCAL"."UBICACION"(
    "ID_UBICACION" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 21) NOT NULL,
...
-- 20 +/- SELECT COUNT(*) FROM TIENDALOCAL.UBICACION;         
...
CREATE CACHED TABLE "TIENDALOCAL"."CATEGORIA"(
    "ID_CATEGORIA" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 21) NOT NULL,
...
-- 20 +/- SELECT COUNT(*) FROM TIENDALOCAL.CATEGORIA;         
...
CREATE CACHED TABLE "TIENDALOCAL"."ESTADO"(
    "ID_ESTADO" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 21) NOT NULL,
...
-- 20 +/- SELECT COUNT(*) FROM TIENDALOCAL.ESTADO;            
...
CREATE CACHED TABLE "TIENDALOCAL"."CLIENTE"(
    "ID_CLIENTE" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 11) NOT NULL,
...
-- 10 +/- SELECT COUNT(*) FROM TIENDALOCAL.CLIENTE;           
...
CREATE CACHED TABLE "TIENDALOCAL"."TECNICO"(
    "ID_TECNICO" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 11) NOT NULL,
...
-- 10 +/- SELECT COUNT(*) FROM TIENDALOCAL.TECNICO;           
