...
CREATE CACHED TABLE "TIENDALOCAL"."PAGO"(
    "ID_PAGO" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 36) NOT NULL,
    "ID_FACTURA" INTEGER,
...
-- 35 +/- SELECT COUNT(*) FROM TIENDALOCAL.PAGO;              
...
(7, 9000.00, 'no centrifuga', TIMESTAMP '2024-10-11 07:26:22', NULL, 7, 1, 1, 6, 2),
