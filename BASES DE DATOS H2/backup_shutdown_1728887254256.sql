...
CREATE CACHED TABLE "TIENDALOCAL"."FACTURA"(
    "ID_FACTURA" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 42) NOT NULL,
    "ESTADO" CHARACTER VARYING(255) NOT NULL,
    "MONTOTOTAL" DECIMAL(10, 2) NOT NULL
);  
ALTER TABLE "TIENDALOCAL"."FACTURA" ADD CONSTRAINT "TIENDALOCAL"."CONSTRAINT_E" PRIMARY KEY("ID_FACTURA");    
-- 41 +/- SELECT COUNT(*) FROM TIENDALOCAL.FACTURA;           
...
CREATE CACHED TABLE "TIENDALOCAL"."PAGO"(
    "ID_PAGO" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 48) NOT NULL,
    "ID_FACTURA" INTEGER,
...
-- 47 +/- SELECT COUNT(*) FROM TIENDALOCAL.PAGO;              
...
CREATE CACHED TABLE "TIENDALOCAL"."REPARACION"(
    "ID_REPARACION" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 10) NOT NULL,
...
-- 9 +/- SELECT COUNT(*) FROM TIENDALOCAL.REPARACION;         
...
-- 9 +/- SELECT COUNT(*) FROM TIENDALOCAL.REPARACION_REPUESTO;
