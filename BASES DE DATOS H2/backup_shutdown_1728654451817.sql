...
CREATE CACHED TABLE "TIENDALOCAL"."FACTURA"(
    "ID_FACTURA" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 31) NOT NULL,
    "ESTADO" CHARACTER VARYING(255) NOT NULL,
    "MONTOTOTAL" DECIMAL(10, 2) NOT NULL
);  
ALTER TABLE "TIENDALOCAL"."FACTURA" ADD CONSTRAINT "TIENDALOCAL"."CONSTRAINT_E" PRIMARY KEY("ID_FACTURA");    
-- 30 +/- SELECT COUNT(*) FROM TIENDALOCAL.FACTURA;           
...
CREATE CACHED TABLE "TIENDALOCAL"."PAGO"(
    "ID_PAGO" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 37) NOT NULL,
    "ID_FACTURA" INTEGER,
...
-- 36 +/- SELECT COUNT(*) FROM TIENDALOCAL.PAGO;              
...
(9, 4, TIMESTAMP '2024-10-11 07:24:55.023345', 100000.00, 10);           
...
CREATE CACHED TABLE "TIENDALOCAL"."REPARACION"(
    "ID_REPARACION" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 18) NOT NULL,
...
-- 6 +/- SELECT COUNT(*) FROM TIENDALOCAL.REPARACION_REPUESTO;
