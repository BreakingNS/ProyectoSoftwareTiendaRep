...
CREATE CACHED TABLE "TIENDALOCAL"."PAGO"(
    "ID_PAGO" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 66) NOT NULL,
    "ID_FACTURA" INTEGER,
...
-- 65 +/- SELECT COUNT(*) FROM TIENDALOCAL.PAGO;              
...
-- 15 +/- SELECT COUNT(*) FROM TIENDALOCAL.REPARACION;        
...
(14, 95000.00, '', TIMESTAMP '2024-10-14 03:47:00', NULL, 58, 2, 2, 2, NULL),
(15, 95000.00, '', TIMESTAMP '2024-10-14 03:47:17', NULL, 59, 2, 3, 2, NULL);
...
-- 15 +/- SELECT COUNT(*) FROM TIENDALOCAL.REPARACION_REPUESTO;               
