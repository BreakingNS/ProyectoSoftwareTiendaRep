...
CREATE CACHED TABLE "TIENDALOCAL"."CLIENTE"(
    "ID_CLIENTE" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 16) NOT NULL,
...
-- 12 +/- SELECT COUNT(*) FROM TIENDALOCAL.CLIENTE;           
...
CREATE CACHED TABLE "TIENDALOCAL"."FACTURA"(
    "ID_FACTURA" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 32) NOT NULL,
    "ESTADO" CHARACTER VARYING(255) NOT NULL,
    "MONTOTOTAL" DECIMAL(10, 2) NOT NULL
);  
ALTER TABLE "TIENDALOCAL"."FACTURA" ADD CONSTRAINT "TIENDALOCAL"."CONSTRAINT_E" PRIMARY KEY("ID_FACTURA");    
-- 31 +/- SELECT COUNT(*) FROM TIENDALOCAL.FACTURA;           
...
CREATE CACHED TABLE "TIENDALOCAL"."PAGO"(
    "ID_PAGO" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 38) NOT NULL,
    "ID_FACTURA" INTEGER,
...
-- 37 +/- SELECT COUNT(*) FROM TIENDALOCAL.PAGO;              
...
(7, 7, 0.00, TIMESTAMP '2024-10-11 07:26:23.713', NULL),
(8, 8, 0.00, TIMESTAMP '2024-10-11 07:27:05.934502', NULL),
(9, 9, 0.00, TIMESTAMP '2024-10-11 07:27:46.859735', NULL),
(10, 10, 0.00, TIMESTAMP '2024-10-11 07:47:47.468493', NULL),
(11, 11, 55000.00, TIMESTAMP '2024-10-11 07:47:54.617799', NULL),
(12, 11, 0.00, TIMESTAMP '2024-10-11 07:49:10.982557', ''),
(13, 12, 90000.00, TIMESTAMP '2024-10-11 07:50:13.112734', NULL),
(14, 13, 50000.00, TIMESTAMP '2024-10-11 07:50:25.365957', NULL),
(15, 13, 3000.00, TIMESTAMP '2024-10-11 07:50:31.391245', ''),
(16, 14, 0.00, TIMESTAMP '2024-10-11 07:55:19.040878', NULL),
(17, 15, 0.00, TIMESTAMP '2024-10-11 07:55:22.476491', NULL),
(18, 16, 0.00, TIMESTAMP '2024-10-11 07:55:44.883899', NULL),
(19, 17, 0.00, TIMESTAMP '2024-10-11 07:57:51.429722', NULL),
(20, 18, 0.00, TIMESTAMP '2024-10-11 08:15:37.069734', NULL),
(21, 19, 0.00, TIMESTAMP '2024-10-11 08:15:55.592635', NULL),
(22, 20, 2000.00, TIMESTAMP '2024-10-11 08:15:59.524348', NULL),
(23, 21, 2000.00, TIMESTAMP '2024-10-11 08:16:00.653773', NULL),
(24, 22, 2000.00, TIMESTAMP '2024-10-11 08:16:00.850599', NULL),
(25, 23, 2000.00, TIMESTAMP '2024-10-11 08:16:01.020534', NULL),
(26, 24, 2001.00, TIMESTAMP '2024-10-11 08:16:26.135283', NULL),
(27, 25, 2000.00, TIMESTAMP '2024-10-11 08:16:39.682147', NULL),
(28, 26, 2000.00, TIMESTAMP '2024-10-11 08:16:55.631835', NULL),
(29, 27, 20000.00, TIMESTAMP '2024-10-11 08:25:02.56409', NULL),
(30, 28, 0.00, TIMESTAMP '2024-10-11 08:28:36.871773', NULL),
(31, 29, 53000.00, TIMESTAMP '2024-10-11 08:29:46.999969', NULL),
(32, 18, 2000.00, TIMESTAMP '2024-10-11 08:32:20.641163', ''),
(33, 30, 0.00, TIMESTAMP '2024-10-11 08:45:31.571815', NULL),
(34, 7, 3000.00, TIMESTAMP '2024-10-11 09:20:25.540676', ''),
(35, 7, 2000.00, TIMESTAMP '2024-10-11 09:21:40.052637', ''),
(36, 7, 1000.00, TIMESTAMP '2024-10-11 09:25:38.703629', ''),
(37, 31, 0.00, TIMESTAMP '2024-10-11 10:52:34.097036', NULL);    
CREATE CACHED TABLE "TIENDALOCAL"."VENTA"(
    "ID_VENTA" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 10) NOT NULL,
...
-- 4 +/- SELECT COUNT(*) FROM TIENDALOCAL.VENTA;              
INSERT INTO "TIENDALOCAL"."VENTA" VALUES
(6, 4, TIMESTAMP '2024-10-11 07:21:20.177218', 100000.00, 3),
(7, 1, TIMESTAMP '2024-10-11 07:21:24.968244', 25000.00, 2),
(8, 1, TIMESTAMP '2024-10-11 07:21:30.746079', 25000.00, 3),
(9, 3, TIMESTAMP '2024-10-11 10:49:31.9977', 75000.00, 10);              
...
(1, 40, 'Q2235', 1, 4, 3, 1, 6),
(2, 15, 'Q7748', 2, 1, 4, 2, 1),
(3, 9, 'W5511', 3, 3, 1, 3, 4),
(4, 50, 'T1114', 4, 2, 2, 4, 6),
(5, 6, 'H4471', 9, 2, 4, 3, 1),
(6, 57, 'J1144', 5, 5, 5, 4, 1);         
CREATE CACHED TABLE "TIENDALOCAL"."PRECIO"(
    "ID_PRECIO" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 10) NOT NULL,
...
-- 9 +/- SELECT COUNT(*) FROM TIENDALOCAL.PRECIO;             
...
(7, TIMESTAMP '2024-10-11 10:34:04.114203', 35000.00, 4),
(8, TIMESTAMP '2024-10-11 10:34:32.801668', 50000.00, 4),
(9, TIMESTAMP '2024-10-11 10:34:57.959148', 80000.00, 4);   
CREATE CACHED TABLE "TIENDALOCAL"."REPARACION"(
    "ID_REPARACION" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 19) NOT NULL,
...
-- 6 +/- SELECT COUNT(*) FROM TIENDALOCAL.REPARACION;         
INSERT INTO "TIENDALOCAL"."REPARACION" VALUES
(7, 15000.00, 'no centrifuga', TIMESTAMP '2024-10-11 07:26:22', NULL, 7, 1, 1, 6, 1),
(12, 84000.00, '', TIMESTAMP '2024-10-11 08:15:32', NULL, 18, 3, 2, 7, 2),
(14, 20000.00, '', TIMESTAMP '2024-10-11 08:25:00', NULL, 27, 1, 3, 2, 1),
(16, 53000.00, '', TIMESTAMP '2024-10-11 08:29:44', NULL, 29, 2, 2, 6, 1),
(17, 85000.00, '', TIMESTAMP '2024-10-11 08:45:29', TIMESTAMP '2024-10-11 00:00:00', 30, 1, 2, 1, 2),
(18, 20000.00, '', TIMESTAMP '2024-10-11 10:52:32', TIMESTAMP '2024-10-11 00:00:00', 31, 1, 3, 2, 2);        
...
-- 4 +/- SELECT COUNT(*) FROM TIENDALOCAL.VENTA_REPUESTO;     
