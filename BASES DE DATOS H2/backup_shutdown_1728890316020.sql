...
CREATE CACHED TABLE "TIENDALOCAL"."FACTURA"(
    "ID_FACTURA" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 60) NOT NULL,
    "ESTADO" CHARACTER VARYING(255) NOT NULL,
    "MONTOTOTAL" DECIMAL(10, 2) NOT NULL
);  
ALTER TABLE "TIENDALOCAL"."FACTURA" ADD CONSTRAINT "TIENDALOCAL"."CONSTRAINT_E" PRIMARY KEY("ID_FACTURA");    
-- 59 +/- SELECT COUNT(*) FROM TIENDALOCAL.FACTURA;           
...
CREATE CACHED TABLE "TIENDALOCAL"."PAGO"(
    "ID_PAGO" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 70) NOT NULL,
    "ID_FACTURA" INTEGER,
...
-- 69 +/- SELECT COUNT(*) FROM TIENDALOCAL.PAGO;              
...
(63, 57, 0.00, TIMESTAMP '2024-10-14 03:46:46.797745', NULL);           
INSERT INTO "TIENDALOCAL"."PAGO" VALUES
(64, 58, 5000.00, TIMESTAMP '2024-10-14 03:47:03.301286', NULL),
(65, 59, 95000.00, TIMESTAMP '2024-10-14 03:47:19.889361', NULL),
(66, 58, 50000.00, TIMESTAMP '2024-10-14 04:10:16.786348', ''),
(67, 58, 30000.00, TIMESTAMP '2024-10-14 04:10:29.834913', ''),
(68, 58, 10000.00, TIMESTAMP '2024-10-14 04:10:33.744042', ''),
(69, 57, 95000.00, TIMESTAMP '2024-10-14 04:12:02.798734', '');              
...
CREATE CACHED TABLE "TIENDALOCAL"."REPARACION"(
    "ID_REPARACION" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 16) NOT NULL,
...
-- 13 +/- SELECT COUNT(*) FROM TIENDALOCAL.REPARACION;        
...
(13, 95000.00, '', TIMESTAMP '2024-10-14 03:46:44', NULL, 57, 2, 3, 2, NULL);              
...
-- 13 +/- SELECT COUNT(*) FROM TIENDALOCAL.REPARACION_REPUESTO;               
