...
public class TecnicoServiceTest {
    ...
    @Test
    public void agregarTecnico() throws SQLException{
        //Marca
    ...
    @Test
    public void listarTecnicos() throws SQLException{
        agregarTecnico();
        List<Tecnico> listaTecnicos = tecnicoService.listarTecnicos();
        
        assertEquals(1, listaTecnicos.get(0).getId_tecnico());
        assertEquals("Mario", listaTecnicos.get(0).getNombre_tecnico());
        assertEquals("Ingresado", listaTecnicos.get(0).getListaReparaciones().get(0).getEstado().getNombre_estado());
        
        assertEquals(2, listaTecnicos.get(1).getId_tecnico());
        assertEquals("Pablo", listaTecnicos.get(1).getNombre_tecnico());
        assertEquals("En Revision", listaTecnicos.get(1).getListaReparaciones().get(0).getEstado().getNombre_estado());
    }
    
    @Test
    public void obtenerTecnicoPorId() throws SQLException{
        agregarTecnico();
        Tecnico tecnico = tecnicoService.obtenerTecnicoPorId(2);
        
        assertEquals(2, tecnico.getId_tecnico());
        assertEquals("Pablo", tecnico.getNombre_tecnico());
        assertEquals("En Revision", tecnico.getListaReparaciones().get(0).getEstado().getNombre_estado());
    }
    
    @Test
    public void busquedaDeTecnico() throws SQLException{
        agregarTecnico();
        Tecnico tecnico = new Tecnico(0, "", "", "5577", "", new ArrayList<>());
    ...
    @Test
    public void editarTecnicoPorId() throws SQLException{
        agregarTecnico();
        Tecnico tecnico = new Tecnico(1, "Carlos", "Carrizo", "3834000000", "", new ArrayList<>());
        tecnicoService.editarTecnicoPorId(tecnico);
        tecnico = tecnicoService.obtenerTecnicoPorId(1);
        
        assertEquals(1, tecnico.getId_tecnico());
        assertEquals("Carrizo", tecnico.getApellido_tecnico());
        assertEquals("3834000000", tecnico.getTelefono_tecnico());
    }
    
    //A revision, pareciera necesitar la query metodo cascada
    /*
    @Test
    public void eliminarTecnicoPorId(){
        agregarTecnico();
        tecnicoService.eliminarTecnicoPorId(1);
        
        List<Tecnico> listaTecnicos = tecnicoService.listarTecnicos();
        
        assertEquals(2, listaTecnicos.get(0).getId_tecnico());
        assertEquals("Maria", listaTecnicos.get(0).getNombre());
        assertEquals("Presupuesto", listaTecnicos.get(0).getListaReparaciones().get(0).getEstado());
    }
    */
    
    @Test
    public void existeTecnico() throws SQLException{
        agregarTecnico();
        Tecnico tecnico = tecnicoService.obtenerTecnicoPorId(2);
        
        assertEquals(true, tecnicoService.existeTecnico(tecnico));
    }
    
    @Test
    public void existeTelefonoTecnico() throws SQLException{
        agregarTecnico();
        Tecnico tecnico = tecnicoService.obtenerTecnicoPorId(1);
        
        assertEquals(true, tecnicoService.existeTelefonoTecnico(tecnico));
    }
}   
