...
public class ReparacionServiceTest {
    ...
    @Test
    public void agregarReparaciones() throws SQLException{
        //Marca
    ...
    @Test
    public void listarReparaciones() throws SQLException{
        agregarReparaciones();
    ...
    @Test
    public void obtenerReparacionPorId() throws SQLException{
        agregarReparaciones();
    ...
    @Test
    public void editarReparacion() throws SQLException{
        agregarReparaciones();
        Reparacion reparacion = reparacionService.obtenerReparacionPorId(1);
    ...
    */
    ...
    public void nuevaReparacion() throws SQLException{
        ...
        Reparacion reparacion = reparacionService.obtenerReparacionPorId(5);
        reparacion.setCosto(new BigDecimal("350000"));
        reparacion.setDetalles("En reparacion por problemas secundarios");
        reparacionDAO.crearReparacion(reparacion);
        reparacion = reparacionDAO.obtenerReparacion(11);
        
        assertEquals(5, reparacion.getId_reparacion());
        assertEquals("350000.00", reparacion.getCosto().toString());
        ...
        assertEquals(6, repuesto1.getStock());
