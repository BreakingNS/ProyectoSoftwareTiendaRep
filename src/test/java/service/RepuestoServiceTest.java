...
public class RepuestoServiceTest {
    ...
    public void listarRepuestos() throws SQLException{
        ...
        assertEquals(6, listaRepuestos.get(0).getStock());
        assertEquals("Fiat", listaRepuestos.get(0).getMarca().getNombre_marca());
        
        assertEquals(2, listaRepuestos.get(1).getId_repuesto());
        assertEquals(16, listaRepuestos.get(1).getStock());
        assertEquals("Fiat", listaRepuestos.get(1).getMarca().getNombre_marca());
    }
    ...
    public void obtenerRepuestoPorId() throws SQLException{
        ...
        assertEquals(16, repuesto.getStock());
        assertEquals("Fiat", repuesto.getMarca().getNombre_marca());
    }
    ...
    */
    ...
    public void actualizarStock() throws SQLException{
        ...
        assertEquals(1, repuesto.getId_repuesto());
        assertEquals(56, repuesto.getStock());
    }
}
