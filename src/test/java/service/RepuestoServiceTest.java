...
public class RepuestoServiceTest {
    ...
    @Test
    public void agregarRepuestos() throws SQLException{
        //Marca
    ...
    @Test
    public void listarRepuestos() throws SQLException{
        agregarRepuestos();
        ...
        assertEquals("Generico", listaRepuestos.get(0).getMarca().getNombre_marca());
        
        assertEquals(2, listaRepuestos.get(1).getId_repuesto());
        assertEquals(17, listaRepuestos.get(1).getStock());
        assertEquals("Panasonic", listaRepuestos.get(1).getMarca().getNombre_marca());
    }
    
    @Test
    public void obtenerRepuestoPorId() throws SQLException{
        agregarRepuestos();
        Repuesto repuesto = repuestoService.obtenerRepuestoPorId(2);
        
        assertEquals(2, repuesto.getId_repuesto());
        assertEquals(17, repuesto.getStock());
        assertEquals("Panasonic", repuesto.getMarca().getNombre_marca());
    }
    
    @Test
    public void editarRepuestoPorId() throws SQLException{
        agregarRepuestos();
