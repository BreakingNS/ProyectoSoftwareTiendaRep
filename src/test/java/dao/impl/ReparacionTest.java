...
public class ReparacionTest {
    ...
    public void pruebaCrearReparacion() throws SQLException{
        ...
        Cliente cliente2 = new Cliente(1, "Franco", "Espindola", "3834001234", new ArrayList<>(), new ArrayList<>());
        Cliente cliente3 = new Cliente(2, "Cristina", "Aguilera", "3834874457", new ArrayList<>(), new ArrayList<>());
        Cliente cliente4 = new Cliente(1, "Miriam", "Nieva", "3834987445", new ArrayList<>(), new ArrayList<>());
        Cliente cliente5 = new Cliente(2, "Lisandro", "Martinez", "3834132345", new ArrayList<>(), new ArrayList<>());
        Cliente cliente6 = new Cliente(1, "Pablo", "Perez", "3834445778", new ArrayList<>(), new ArrayList<>());
        Cliente cliente7 = new Cliente(2, "Judith", "Argañaraz", "3834998665", new ArrayList<>(), new ArrayList<>());
        Cliente cliente8 = new Cliente(1, "Marla", "Perea", "3834774477", new ArrayList<>(), new ArrayList<>());
        Cliente cliente9 = new Cliente(2, "Vanesa", "Rizzardo", "3834887552", new ArrayList<>(), new ArrayList<>());
        ...
        Repuesto repuesto2 = new Repuesto(3, 45, nombreRepuesto2, marca2, categoria2, new ArrayList<>(), ubicacion2);
        Repuesto repuesto3 = new Repuesto(4, 100, nombreRepuesto3, marca3, categoria3, new ArrayList<>(), ubicacion3);
        Repuesto repuesto4 = new Repuesto(5, 90, nombreRepuesto4, marca4, categoria1, new ArrayList<>(), ubicacion4);
        Repuesto repuesto5 = new Repuesto(6, 80, nombreRepuesto5, marca5, categoria3, new ArrayList<>(), ubicacion5);
        ...
        Reparacion reparacion1 = new Reparacion(1, new BigDecimal("20000"), "Rota la tapa", fecha3, fecha4, Boolean.TRUE, categoria, cliente, estado); 
        Reparacion reparacion2 = new Reparacion(2, new BigDecimal("18000"), "Color plateado", fecha4, fecha5, Boolean.TRUE, categoria1, cliente1, estado1); 
        Reparacion reparacion3 = new Reparacion(3, new BigDecimal("80000"), "no gira", fecha5, fecha0, Boolean.FALSE, categoria2, cliente2, estado2); 
        Reparacion reparacion4 = new Reparacion(4, new BigDecimal("9000"), "", fecha6, fecha7, Boolean.TRUE, categoria3, cliente3, estado3); 
        Reparacion reparacion5 = new Reparacion(5, new BigDecimal("9000"), "pierde por manguera", fecha7, fecha7, Boolean.TRUE, categoria, cliente4, estado4); 
        Reparacion reparacion6 = new Reparacion(6, new BigDecimal("15000"), "no tiene gas", fecha8, fecha0, Boolean.FALSE, categoria, cliente2, estado5); 
        Reparacion reparacion7 = new Reparacion(7, new BigDecimal("10000"), "no enfria", fecha9, fecha10, Boolean.TRUE, categoria, cliente4, estado6); 
        Reparacion reparacion8 = new Reparacion(8, new BigDecimal("10000"), "", fecha10, fecha11, Boolean.FALSE, categoria, cliente2, estado7); 
        Reparacion reparacion9 = new Reparacion(9, new BigDecimal("6000"), "no cierra la tapa", fecha11, fecha0, Boolean.FALSE, categoria, cliente, estado8); 
        Reparacion reparacion10 = new Reparacion(10, new BigDecimal("15000"), "plaqueta dañada", fecha12, fecha0, Boolean.TRUE, categoria, cliente8, estado1); 
        */
        /*
