...
public class VentaRepuestoTest {
    ...
    @Test
    public void crearVentaRepuesto() throws SQLException{
        //Marca
    ...
    @Test
    public void obtenerVentaRepuestos() throws SQLException{
        crearVentaRepuesto();
    ...
    @Test
    public void obtenerVentaRepuestoPorVenta() throws SQLException{
        crearVentaRepuesto();
    ...
    @Test
    public void obtenerVentaRepuestoPorRepuesto() throws SQLException{
        crearVentaRepuesto();
        List<VentaRepuesto> listaVentaRepuestos = ventaRepuestoDAO.obtenerVentaRepuestoPorVenta(2);
    ...
    @Test
    public void actualizarAgregarVentaRepuestoPorVenta() throws SQLException{
        crearVentaRepuesto();
    ...
    @Test
    public void actualizarEliminarVentaRepuestoPorRepuesto() throws SQLException{
        crearVentaRepuesto();
    ...
    @Test
    public void eliminarVentaRepuesto() throws SQLException{
        crearVentaRepuesto();
    ...
    @Test
    public void eliminarVentaRepuestoPorVenta() throws SQLException{
        crearVentaRepuesto();
