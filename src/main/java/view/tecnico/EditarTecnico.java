...
public class EditarTecnico extends javax.swing.JFrame {
    ...
    public EditarTecnico(int id, TecnicoController tecnicoController) {
        this.tecnicoController = tecnicoController;
        this.id = id;
        initComponents();
        cargarDatosTecnico(id);
        configurarEventos();
    }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        tecnicoController.editarTecnico(id, nombre, apellido, telefono, domicilio);
    ...
    private void cargarDatosTecnico(int id){
        Tecnico tecnico = tecnicoController.obtenerTecnicoPorId(id);
        
        txtNombre.setText(tecnico.getNombre_tecnico());
        txtApellido.setText(tecnico.getApellido_tecnico());
        txtTelefono.setText(tecnico.getTelefono_tecnico());
        txtDomicilio.setText(tecnico.getDomicilio_tecnico());
    }
