...
public class VistaTecnico extends javax.swing.JFrame {
    ...
    public VistaTecnico (TecnicoController tecnicoController, Connection connection) {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (opcion == JOptionPane.YES_OPTION) {
            ...
            tecnicoController.eliminarTecnico(idTecnico);
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        AltaTecnico alta = new AltaTecnico(tecnicoController);
        ...
        alta.addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosed(java.awt.event.WindowEvent e) {
                VistaTecnico.this.setEnabled(true);
                VistaTecnico.this.setState(JFrame.NORMAL);  
                VistaTecnico.this.toFront();                
                VistaTecnico.this.requestFocus();  
                cargarTabla(); // Actualiza la tabla después de cerrar AltaTecnico.
            }
        });
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if(tablaTecnicos.getRowCount() > 0){
            if(tablaTecnicos.getSelectedRow()!=-1){
                ...
                this.setEnabled(false);
                EditarTecnico alta = new EditarTecnico(idTecnico, tecnicoController);
                //alta.setSize(600, 400);
                alta.setResizable(false);
                alta.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
                alta.setVisible(true);
    ...
    private void cargarTabla(){
        ...
        //Traer Tecnicos desde la base de datos
        List<Tecnico> listaTecnicos = tecnicoController.listarTecnicos();
        
        System.out.println("el tamaño de la lista es: " + listaTecnicos.size());
        
        //Setear los datos en la tabla
        if(listaTecnicos != null){
            System.out.println("tamaño de la lista: " + listaTecnicos.size());
            for(Tecnico tecnico : listaTecnicos){
                Object[] objeto = {tecnico.getId_tecnico(), tecnico.getNombre_tecnico(), tecnico.getApellido_tecnico(), tecnico.getTelefono_tecnico(), tecnico.getDomicilio_tecnico()};
    ...
    private void configurarEventos() {
        ...
        tablaTecnicos.getSelectionModel().addListSelectionListener(e -> {
            btnEliminar.setEnabled(tablaTecnicos.getSelectedRow() != -1); // Habilita si hay una fila seleccionada.
        });
        
        btnEditar.setEnabled(false); // Deshabilita el botón inicialmente.

        tablaTecnicos.getSelectionModel().addListSelectionListener(e -> {
            btnEditar.setEnabled(tablaTecnicos.getSelectedRow() != -1); // Habilita si hay una fila seleccionada.
        });
    ...
    private void buscarYActualizarTabla() {
        ...
        List<Tecnico> listaTecnicos = tecnicoController.busquedaDeTecnico(nombre, apellido, telefono, domicilio);
        cargarTablaBusqueda(listaTecnicos);
    }
