...
public class EditarModelo extends javax.swing.JFrame {
    ...
    public EditarModelo(int id, ModeloController modeloController) {
        this.id = id;
        this.modeloController = modeloController;
        initComponents();
        cargarDatosModelo(id);
        configurarEventos();
    }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (modeloController.existeModelo(nombre)) {
            JOptionPane.showMessageDialog(null, "Error: La modelo ya existe con ese nombre.", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
            modeloController.editarModelo(id, nombre);
    ...
    private void cargarDatosModelo(int id) {
        Modelo modelo = modeloController.obtenerModeloPorId(id);
        
        txtNombre.setText(modelo.getNombre_modelo());
    }
