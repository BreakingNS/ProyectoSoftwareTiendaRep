...
public class EditarNombreRepuesto extends javax.swing.JFrame {

    private final NombreRepuestoController nombreRepuestoController;
    private final int id;
    
    public EditarNombreRepuesto(int id, NombreRepuestoController nombreRepuestoController) {
        this.id = id;
        this.nombreRepuestoController = nombreRepuestoController;
        initComponents();
        cargarDatosNombreRepuesto(id);
        configurarEventos();
    }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Editar Nomb-Rep");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (nombreRepuestoController.existeNombreRepuesto(nombre)) {
            ...
            nombreRepuestoController.editarNombreRepuesto(id, nombre);
    ...
    private void cargarDatosNombreRepuesto(int id) {
        NombreRepuesto nombreRepuesto = nombreRepuestoController.obtenerNombreRepuestoPorId(id);
        
        txtNombre.setText(nombreRepuesto.getNombre_repuesto());
    }
