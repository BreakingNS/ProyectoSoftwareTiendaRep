...
public class EditarUbicacion extends javax.swing.JFrame {
    ...
    public EditarUbicacion(int id, UbicacionController ubicacionController) {
        this.id = id;
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Editar Ubicacion");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (ubicacionController.existeUbicacion(nombre)) {
            JOptionPane.showMessageDialog(null, "Error: La ubicacion ya existe con ese nombre.", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
            ubicacionController.editarUbicacion(id, nombre);
    ...
    private void cargarDatosUbicacion(int id) {
        Ubicacion ubicacion = ubicacionController.obtenerUbicacionPorId(id);
        
        txtNombre.setText(ubicacion.getNombre_ubicacion());
    }
