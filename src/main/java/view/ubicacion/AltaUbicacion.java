...
public class AltaUbicacion extends javax.swing.JFrame {

    private final UbicacionController ubicacionController;
    
    public AltaUbicacion(UbicacionController ubicacionController) {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Alta Ubicacion");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (ubicacionController.existeUbicacion(nombre)) {
            ...
            ubicacionController.agregarUbicacion(nombre);
