...
import view.ventas.EditarVenta;

public class ActualizarRepuestos extends javax.swing.JFrame {
    ...
    public ActualizarRepuestos(ReparacionController reparacionController, 
    ...
    private void initComponents() {
        ...
        btnClienteNuevo.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        btnClienteNuevo.setText("NUEVO CLIENTE");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(comboCategoria2, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(btnClienteNuevo, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnClienteNuevo, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(lblCategoria)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        LocalDateTime fechaIngreso = reparacionSeleccionado.getFecha_ingreso().truncatedTo(ChronoUnit.SECONDS);
        
        //costoTotal = costoManoDeObra.add(costoTotalRepuesto);
        
        Reparacion reparacion = new Reparacion(reparacionSeleccionado.getId_reparacion(), costoTotal, detalles, fechaIngreso, fechaDevolucion, reparacionSeleccionado.getFactura(), categoriaSeleccionada, cliente, estadoSeleccionado, tecnicoSeleccionado);
        
        //FACTURA
                
        reparacionSeleccionado.getFactura().setMontoTotal(costoTotal);
        /*
        System.out.println("--------------------");
        System.out.println("costoTotalRepuesto: " + costoTotalRepuesto);
        System.out.println("costoManoDeObra: " + costoManoDeObra);
    ...
    private void btnClienteNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClienteNuevoActionPerformed
        ...
        alta.addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosed(java.awt.event.WindowEvent e) {
                ActualizarRepuestos.this.setEnabled(true);
                ActualizarRepuestos.this.setState(JFrame.NORMAL);  
                ActualizarRepuestos.this.toFront();                
                ActualizarRepuestos.this.requestFocus();  
    ...
    private void cargarTablas(){
        ...
        //Cargar Selecciones
        cargarTodosLosElementosEditables();
    ...
    private void cargarTodosLosElementosEditables(){
        comboCategoria2.setSelectedItem(reparacionSeleccionado.getCategoria().getNombre_categoria());
        comboEstado2.setSelectedItem(reparacionSeleccionado.getEstado().getNombre_estado());

        if(reparacionSeleccionado.getTecnico()!=null){
            comboTecnico.setSelectedItem(reparacionSeleccionado.getTecnico().getApellido_tecnico().concat(" " + reparacionSeleccionado.getTecnico().getNombre_tecnico()));
        }else{
            comboTecnico.setSelectedItem("-");
        }
        
        txtAreaDetalles.setText(reparacionSeleccionado.getDetalles());
        
        DateTimeFormatter formatoDiasHoras = DateTimeFormatter.ofPattern("dd-MM-yyyy' 'HH:mm");
        String fechaIngreso = reparacionSeleccionado.getFecha_ingreso().format(formatoDiasHoras);
        lblFechaIngreso.setText("Fecha de Ingreso: " + fechaIngreso);
        
        if(reparacionSeleccionado.getFecha_devolucion()!=null){
            DateTimeFormatter formato = DateTimeFormatter.ofPattern("EEEE, dd-MM-yyyy", new Locale("es", "ES"));
            String fechaDevolucionFormateada = reparacionSeleccionado.getFecha_devolucion().format(formato);

            comboFechaDevolucion1.setSelectedItem(fechaDevolucionFormateada);
        }else{
            comboFechaDevolucion1.setSelectedItem("-");
        }
        
        JTable tablaClientesBuscar = tablaClientes;
        
        
        if (tablaClientes.getRowCount() > 0 && tablaClientes.getColumnCount() > 0) {
            for (int i = 0; i < tablaClientes.getRowCount(); i++) {
                int idCliente = (int) tablaClientes.getValueAt(i, 0); // obtiene el id de la columna 0
                if (idCliente == reparacionSeleccionado.getCliente().getId_cliente()) {
                    tablaClientes.setRowSelectionInterval(i, i); // selecciona la fila
                    
                    // Simular evento de clic
                    java.awt.event.MouseEvent evt = new java.awt.event.MouseEvent(
                        tablaClientes, java.awt.event.MouseEvent.MOUSE_CLICKED, 
                        System.currentTimeMillis(), 0, 0, 0, 1, false);
                    for (java.awt.event.MouseListener listener : tablaClientes.getMouseListeners()) {
                        listener.mouseClicked(evt); // Dispara el evento de clic
                    }
        ...
        if(total != BigDecimal.ZERO){
            costoTotalRepuesto = total;
        }
        else{
            costoTotalRepuesto = BigDecimal.ZERO;
        }
        
        BigDecimal costoBig = reparacionSeleccionado.getCosto();
        
        txtManoDeObra.setText((costoBig.subtract(total)).toString());
        
    }
    
    public void calcularValorTotal(){
        costoTotal = costoTotalRepuesto.add(costoManoDeObra);
