...
public class AltaReparacionVIEJO extends javax.swing.JFrame {
    ...
    private final BigDecimal costoManoDeObra = BigDecimal.ZERO;
    private BigDecimal costoTotal = BigDecimal.ZERO;
    
    public AltaReparacionVIEJO(ReparacionController reparacionController, 
        ...
        listaRepuestos = repuestoController.listarRepuestos();
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        alta.addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosed(java.awt.event.WindowEvent e) {
                AltaReparacionVIEJO.this.setEnabled(true);
                AltaReparacionVIEJO.this.setState(JFrame.NORMAL);  
                AltaReparacionVIEJO.this.toFront();                
                AltaReparacionVIEJO.this.requestFocus();  
    ...
    private void configurarListeners() {
        ...
        // DocumentListener para los JTextField
        DocumentListener docListenerManoDeObra = new DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                calcularValorTotal(); // Actualiza la tabla cuando se inserta texto
            }

            @Override
            public void removeUpdate(DocumentEvent e) {
                calcularValorTotal(); // Actualiza la tabla cuando se elimina texto
            }
        ...
        txtManoDeObra.getDocument().addDocumentListener(docListenerManoDeObra);
        ...
        comboCategoria2.addActionListener(e -> actualizarEstadoBoton()); // Llamar al cambiar la categoría
        comboEstado2.addActionListener(e -> actualizarEstadoBoton()); // Llamar al cambiar el estado
