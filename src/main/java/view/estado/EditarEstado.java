...
public class EditarEstado extends javax.swing.JFrame {
    ...
    public EditarEstado(int id, EstadoController estadoController) {
        this.id = id;
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (estadoController.existeEstado(nombre)) {
            JOptionPane.showMessageDialog(null, "Error: El estado ya existe con ese nombre.", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
            estadoController.editarEstado(id, nombre);
    ...
    private void cargarDatosEstado(int id) {
        Estado estado = estadoController.obtenerEstadoPorId(id);
