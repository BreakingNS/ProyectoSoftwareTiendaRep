...
public class AltaEstado extends javax.swing.JFrame {

    private final EstadoController estadoController;
    
    public AltaEstado(EstadoController estadoController) {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (estadoController.existeEstado(nombre)) {
            JOptionPane.showMessageDialog(null, "Error: La estado ya existe con ese nombre.", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
            estadoController.agregarEstado(nombre);
